...
const ProductAdminPage: FC<Props> = ({ product }) => {
  ...
  useEffect(() => {
    // subscription para ver cuando cambia titulo
    ...
    return () => subscription.unsubscribe() // el watch crea un observable por lo que hay que limpiarlo
  }, [watch, setValue])
          ...
          <Grid item xs={12} sm={6}>
            ...
            <FormControl sx={{ mb: 1 }}>
              ...
              <RadioGroup
                ...
                onChange={
                  ({ target }) =>
                    setValue('type', target.value, { shouldValidate: true }) // -> shouldValidate para que se re renderice
                }
              >
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              {...register('slug', {
                required: 'Este campo es requerido',
                validate: (
                  val // validacion espacio en blanco
                ) =>
                  val.trim().includes(' ')
